...
**Dernière mise à jour** : 2026-06-24 (conv 84) — DETTE #112 LEVÉE : l'inscription écrit bien le rythme (test bout-en-bout local, rhythm_calendar = 61 semaines au format VISION). Pas une dette de code. Reste : compte hôte de test + reprise 1a→1b sur /logement + commit de l'étape 1a.
