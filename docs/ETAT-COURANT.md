...
**LES TROIS GESTES SONT FAITS, DANS L'ORDRE IMPÉRATIF.** Feuille de réponses créée sur la copie, copie publiée, original fermé en pointant vers elle. La campagne de septembre peut être diffusée. **FEUILLE DE RÉPONSES.** Créée par "Créer une feuille de calcul", jamais par liaison à une feuille existante — lier la copie à la feuille de l'original aurait empilé les deux vagues dans le même onglet et rendu la rupture de série illisible. Fichier "Trouver un logement en alternance (réponses)", 0 ligne de données. **LE VOLET 1 EST VALIDÉ PAR LA FEUILLE ELLE-MÊME.** Dernière colonne remplie : AQ, soit 43 colonnes, soit l'horodateur plus les 42 questions du contrôle final du 18/08. Aucune fusion. C'était précisément ici que des intitulés en double auraient écrasé des colonnes ; le contrôle est mécanique, il n'a pas été fait à l'œil. **L'ORIGINAL N'AVAIT AUCUNE FEUILLE DE RÉPONSES.** Constaté ce jour. Ses 15 réponses ne vivent que dans son onglet Réponses, sans copie ailleurs. La fermeture ne les touche pas, mais elles n'ont aucune sauvegarde : export CSV à faire, tracé en reste. **PUBLICATION DE LA COPIE.** Répondants réglés sur "Tous les utilisateurs qui ont le lien" — aucun compte Google requis. Piège écarté : le lien "Limiter à Sterny", placé juste sous ce réglage, aurait restreint la réponse à l'espace de travail, donc à Côme seul. Lien court retenu pour la diffusion : https://forms.gle/wAvGz4yrdPEHkEsJ8. La case "Raccourcir l'URL" n'est pas un réglage enregistrable mais un basculeur d'affichage : elle revient décochée à chaque ouverture, les deux formes du lien restent valides en permanence. **VÉRIFIÉ EN NAVIGATION PRIVÉE, PAS DEPUIS LE COMPTE PROPRIÉTAIRE.** Le formulaire s'ouvre sans compte, bouton Suivant actif, aucun bandeau de refus, titre sans préfixe "V1 - " donc bien la copie. Le clic "Envoyer" reste à ce jour le seul geste jamais exercé du questionnaire. **FERMETURE DE L'ORIGINAL.** Message de remplacement posé AVANT la bascule, pour qu'aucun visiteur ne tombe sur un formulaire clos portant le texte par défaut, qui ne mène nulle part. Message vérifié en navigation privée : sauts de ligne préservés au rendu réel là où l'aperçu du panneau les écrasait, et lien cliquable. Les 15 réponses sont intactes, le formulaire reste consultable. **LE RÉGLAGE A DÉMÉNAGÉ, ET SON INTITULÉ EST INVERSÉ.** "Accepter les réponses" ne vit plus dans l'onglet Réponses : il est sous le bouton "Publié" en haut à droite, dans "Options de publication", renommé "Les réponses ne sont plus acceptées". Formulation négative : il faut ACTIVER la bascule pour FERMER. Claude.ai a donné deux fois l'emplacement de mémoire et s'est trompé deux fois ; l'emplacement correct vient de la documentation Google, le sens de la bascule d'un test réel en navigation privée. Le doute a été levé par constat, pas par raisonnement. **CIRCULATION DE L'ANCIEN LIEN, POINT OUVERT DEPUIS LE 11/08, CLOS.** L'original a circulé dans deux groupes Discord de proches, aucune réponse depuis deux semaines, compteur figé à 15. Un lien dans un historique de conversation n'est ni indexé ni affiché en permanence : le message de fermeture suffit, rien à retirer d'un support public. Conséquence : reposter le nouveau lien dans ces deux groupes, au titre de la diffusion. **RESTE** : exporter les 15 réponses de l'original en CSV ; reposter le lien dans les deux groupes Discord ; diffusion de septembre (groupes d'alternants, écoles) ; envisager une redirection sterny.co/etude, dont l'intérêt est de pouvoir repointer la cible sans changer le lien diffusé, là où un lien Google est figé sur son formulaire.
...
**DEUX QUESTIONS AJOUTÉES APRÈS LA CLÔTURE DU VOLET 2, sur relance de Côme avant les tests.** Motif : une fois la diffusion lancée l'instrument est gelé, tout trou repéré maintenant est le dernier qu'on puisse combler. Aucune section insérée, les deux questions vivent dans des sections existantes.

**SECTION 2 — « Où en es-tu dans ton alternance ? »**, choix unique obligatoire (Je commence cette année / Je suis en cours d'alternance / Mon alternance est terminée), sans redirection. Motif d'analyse : le questionnaire mélange le présent (« Comment fais-tu pour te loger ») et le rétrospectif (« As-tu rencontré des difficultés »), rien n'empêchait un alternant ayant terminé en 2023 de répondre, et un loyer de 2023 ne se compare pas à un loyer de 2026. Sans cette question la distinction était irrécupérable à l'analyse.
POSITION EN PREMIÈRE QUESTION DE LA SECTION, arbitrage de Côme contre la proposition initiale de Claude (dernière position, par prudence sur les redirections de la question rythme). Motif retenu : quelqu'un dont l'alternance est finie qui voit d'abord « Quel est ton cursus ? » au présent conclut que le formulaire ne le concerne pas et ferme. Ouvrir par « où en es-tu » annonce que les trois cas sont attendus. Bénéfice second : le répondant sait s'il doit répondre au présent ou au passé. La prudence invoquée par Claude était infondée — une redirection est attachée à sa question, pas à sa position.

**SECTION 7 — « Combien tes trajets quotidiens te coûtent-ils par mois ? »**, réponse courte obligatoire, en troisième position. Trou créé par le volet 2 lui-même : en invitant le mono-ville sans loyer à répondre 0, on ouvrait la porte à celui qui habite chez ses parents à 40 minutes et fait la route tous les jours — il répondait 0 et son vrai coût, le transport, n'apparaissait nulle part. Asymétrie corrigée : le profil de la section 16 donnait déjà loyer ET trajets, le mono-ville n'aurait donné que le loyer.
BRANCHEMENT ÉCARTÉ AU PROFIT DE LA DESCRIPTION. Ne poser la question qu'aux mono-villes éloignés aurait exigé une section neuve, donc une insertion. La description fait le travail à sa place : « Compte l'essence, le train, le bus… (Si tu vas à pied, à vélo, ou si tu n'as pas de trajet, réponds 0.) » Elle rend le 0 légitime au lieu d'en faire un aveu. Le temps de trajet n'est PAS demandé — deux questions pour un profil secondaire alourdissent le parcours.

**SECTIONS 3 ET 5 — EXAMINÉES, NON MODIFIÉES.** Leur exemple de format vit dans l'intitulé et non dans la description, contrairement à la règle du 14/08. Écart sans conséquence : ces intitulés sont uniques, aucune colonne ne fusionne. Corriger changerait le nom de la colonne dans la feuille de réponses pour un gain de lisibilité nul côté répondant. À ne pas rouvrir.

**CONTRÔLE FINAL, contenu figé.** Dump du 18/08 à 11:09 et `verifierIntitules` à 11:13 : 25 sections, 42 questions, 38 obligatoires, 4 facultatives, 14 descriptions de question, « INTITULES EN DOUBLE : aucun », n'accepte pas les réponses, 0 réponse enregistrée. Points sensibles vérifiés un à un : « APRES LA SECTION 2 » toujours sur « section suivante », « APRES LA SECTION 7 » sur SECTION 18, les trois redirections de la question rythme intactes malgré l'insertion d'une question au-dessus d'elles, et les 25 sorties de section identiques au dump de 10:13. Les deux nouvelles descriptions sont uniques, elles n'ont créé aucun groupe de doublons.

**TEST DE PARCOURS DE BOUT EN BOUT EFFECTUÉ, onze passages à la main.** Couverture vérifiée en recoupant les passages contre le dump du 18/08 à 11:09 : les 3 options de rythme (section 2), les 3 de fréquence irrégulière (section 4), les 4 options classiques PLUS l'option Autre des sections 9 et 10, les 4 options de difficultés (section 18), les 4 de renoncement (section 20), les 4 de fin (section 22), les deux branches de l'opt-in (section 24), les deux entrées distinctes vers la section 11 (depuis 9 et depuis 10), et les sections 12→16, 13, 14, 15, 17. Aucun embranchement inattendu, aucune section orpheline. Les questions facultatives laissent bien passer sans réponse.

**LES DEUX OPTIONS AUTRE DES SECTIONS 9 ET 10 MÈNENT BIEN À LA SECTION 18.** Constaté en les empruntant, pas déduit. C'était la limite structurelle du dump, qui ne dit jamais où mène un Autre. Les options Autre des sections 12, 13 et 20 sont portées par des cases à cocher : elles ne peuvent structurellement rien rediriger, le point est clos sans test. Restent les Autre des sections 2 et 21, traversés au onzième passage sans produire de saut.

**L'APERÇU N'ENREGISTRE AUCUNE RÉPONSE ET NE PEUT PAS ENVOYER.** Question ouverte depuis le 14/08, tranchée par l'expérience : le mode aperçu d'un formulaire non publié affiche « Ce formulaire n'accepte pas de réponses » et bloque l'envoi. La navigation entre sections, elle, fonctionne normalement — c'est ce qui a permis les onze passages sans polluer le compteur, resté à 0. CONSÉQUENCE : le clic « Envoyer » est le SEUL geste du questionnaire jamais exercé. Comportement de Google Forms, pas un réglage du formulaire, mais à garder en tête au premier envoi réel.

**RESTE, dans cet ORDRE IMPÉRATIF** : création de la feuille de réponses, publication de la copie, puis fermeture de l'original en pointant vers la copie. Fermer avant de publier laisserait un trou où plus rien ne collecte. Point non résolu à traiter avant la fermeture : savoir si le lien de l'original a circulé au-delà d'envois directs, auquel cas il faut aussi le retirer de son support public.
