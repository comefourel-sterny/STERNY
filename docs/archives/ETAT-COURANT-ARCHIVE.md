# Archive ETAT-COURANT — entrées antérieures à juin 2026

Entrées de session du 22 avril au 31 mai 2026, déplacées telles quelles depuis `docs/ETAT-COURANT.md` le 3 août 2026 pour alléger le socle chargé à chaque session. Aucune entrée n'a été réécrite ni résumée. Ce fichier n'est pas lu au démarrage, il se consulte à la demande.
