...
> **[Q-AVO-005]** Quand le loyer du logement augmente en cours de contrat (révision annuelle indexée — par exemple l'IRL, Indice de Référence des Loyers publié par l'INSEE qui encadre la révision annuelle d'un bail — ou hausse négociée), comment cette hausse se répercute-t-elle dans le modèle Sterny où plusieurs alternants occupent successivement le logement — une seule personne à la fois, semaines disjointes — chacun ne payant que les semaines qu'il occupe ? Le contrat de partage doit-il se mettre à jour automatiquement (hausse répartie au prorata des semaines de chaque occupant), ou le locataire principal titulaire du bail la supporte-t-il seul ? Quelle clause de révision prévoir dans le contrat de sous-location / mise à disposition ?
...
> **Statut** : RÉPONDU (Benoît Guillemin, mail 07/07/2026 + Snapchat 10/07/2026).
> **Réponse** : mention DPF (Data Privacy Framework) ajoutée, formule validée par Benoît.
> **Priorité** : haute, bloquante avant TOUT lancement (y compris test restreint) — RÉSOLU, gate levé le 10/07/2026 (cf. ETAT-COURANT.md conv 111).
...
> **Statut** : RÉPONDU (Benoît Guillemin, mail 07/07/2026 + Snapchat 10/07/2026).
> **Réponse** : mécanique Oui/Non validée — pas d'obligation de forme, garantit un consentement libre/spécifique/éclairé/univoque.
...
> **Statut** : RÉPONDU (Benoît Guillemin, mail 07/07/2026 + Snapchat 10/07/2026).
> **Réponse** : double format retenu — mention courte in-situ (finalité, contact, durée, lien) + document détaillé séparé (Google Doc, lecture seule).
...
> **Statut** : RÉPONDU (Benoît Guillemin, mail 07/07/2026 + Snapchat 10/07/2026).
> **Réponse** : réutilisation autorisée à des fins statistiques si annoncée dès la collecte et données anonymisées (art. 5.1.b et 89 RGPD).
...
> **Statut** : RÉPONDU (Benoît Guillemin, mail 07/07/2026 + Snapchat 10/07/2026).
> **Réponse** : durée portée de 12 à 24 mois (CNIL tolère jusqu'à 3 ans si justifié), justification métier ajoutée dans le document détaillé.
...
> **Statut** : RÉPONDU (Benoît Guillemin, mail 07/07/2026 + Snapchat 10/07/2026).
> **Réponse** : couvert par le mécanisme Oui/Non de Q-DPO-017, section "Reste en contact" séparée et consentement dédié.
...
**Q-DPO-027 — Table des utilisateurs lisible sans connexion (lecture sans connexion fermée en production le 22/09/2026).** Jusqu'au 22/09/2026, la table des utilisateurs était lisible sans connexion par toute personne disposant de la clé publique de l'application, depuis une date non établie. Cette clé est livrée à tout visiteur de sterny.co : le site est resté en ligne, le public n'y voyant qu'une page d'attente, et le reste de l'application était derrière un mot de passe vérifié dans le navigateur, qui ne protège pas la base. La table contenait 12 comptes : 3 comptes du fondateur, 4 comptes de test et 5 proches ayant volontairement créé un compte pour tester une plateforme qu'ils savaient en développement, avec nom, email, téléphone et parfois date de naissance. Aucun accès par un tiers n'est connu. Le 16/09/2026, l'écriture des colonnes sensibles a été verrouillée ; le 22/09/2026, la lecture sans connexion a été fermée en production. Cette entrée corrige sa version précédente, qui disait la faille corrigée le 16/09 et le site retiré d'internet : les deux mentions étaient inexactes. Tant que la phase A bis n'est pas faite, un utilisateur connecté peut encore fabriquer une relation pour lire la fiche entière d'un autre (voir Q-DPO-030). Cette situation appelle-t-elle une démarche particulière, ou une simple trace interne suffit-elle ?
...
**Q-DPO-030 — Qui lit quoi dans la fiche d'un autre utilisateur (conception révisée du 21/09/2026).** Cette entrée précise Q-DPO-028 et Q-DPO-029, qui comptaient les messages et les mises en relation parmi les relations ouvrant la fiche entière : ce n'est plus le cas. Sans connexion, aucune fiche n'est lisible ; seuls sont accessibles un profil public (prénom, nom, photo, type de compte, école, année, filière, présentation, villes, identité vérifiée ou non) et, à partir d'un lien d'invitation, le prénom et le nom de la personne qui invite. Connecté, un utilisateur lit sa propre fiche, l'administrateur lit toutes les fiches, et un utilisateur lit la fiche entière d'un autre, téléphone, email et date de naissance compris, dans cinq cas seulement : un contrat ou un renouvellement commun ; l'autre a candidaté à l'une de ses annonces, quelle que soit l'issue ; il a candidaté à une annonce de l'autre et sa candidature est acceptée ; l'un a invité l'autre sur Sterny ; ou, pour un propriétaire, l'autre est un candidat accepté sur l'annonce d'un hôte avec qui il est lié par invitation. Ce dernier cas donne à un propriétaire la fiche entière de personnes avec qui il n'a aucun lien direct. Questions : (1) ces cinq accès sont-ils proportionnés à leur finalité, en particulier le dernier ? (2) Le refus d'une candidature doit-il fermer l'accès de l'hôte à la fiche du candidat ? (3) Le profil public, lisible sans connexion, peut-il contenir le nom de famille et la photo ? La restriction des champs par relation (phase B) réduira ces accès ; elle n'est pas faite. Rappel : ces règles sont appliquées en production depuis le 22/09/2026 ; tant que la phase A bis n'est pas faite, un utilisateur connecté peut fabriquer une relation pour lire la fiche entière d'un autre.

**Q-DPO-031 — Transmission des pièces du dossier d'un hôte à son propriétaire.** Un hôte (alternant qui sous-loue ou prête son propre logement) peut-il se voir demander par son propriétaire les pièces de son dossier locataire déposées sur Sterny ? Si oui, Sterny peut-il les lui transmettre, et à quelles conditions ? Contexte : décision du 23/09, un hôte garde l'accès à ses documents dans /compte.
