...
*Dernière modification : 2026-09-15 — §6 bis : scans de secrets par /usr/bin/grep, ugrep échouant en silence sur leur motif (point 5 de la règle sur Claude Code).*
