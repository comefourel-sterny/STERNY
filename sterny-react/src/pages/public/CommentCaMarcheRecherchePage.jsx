...
export default function CommentCaMarcheRecherchePage() {
  return (
    <div className="ccmr">
      {/* HERO */}
      <section className="ccmr-hero">
        <div className="ccmr-hero-inner">
          <span className="ccmr-badge ccmr-stagger">Alternants</span>
          <h1 className="ccmr-stagger" style={{ animationDelay: '0.08s' }}>Un logement adapté à ton alternance</h1>
          <p className="ccmr-stagger" style={{ animationDelay: '0.16s' }}>Paie uniquement en fonction de tes semaines d'occupation, pas un mois complet pour rien</p>
        </div>
      </section>

      {/* ÉTAPES */}
      <section className="ccmr-steps-section">
      ...
      {/* AVANTAGES */}
      <section className="ccmr-avantages-section">
        <div className="ccmr-container">
          <h2 className="ccmr-section-title ccmr-stagger">POURQUOI STERNY</h2>

          <div className="ccmr-grid">
            <div className="ccmr-avantage ccmr-stagger" style={{ animationDelay: '0.08s' }}>
              <div className="ccmr-avantage-icon">
            ...
            <div className="ccmr-avantage ccmr-stagger" style={{ animationDelay: '0.16s' }}>
              <div className="ccmr-avantage-icon">
                <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20" fill="white">
              ...
              <h4>Paie selon ton occupation</h4>
              <p>Fini de payer un loyer complet quand tu n'es là que 2 semaines par mois.</p>
            </div>

            <div className="ccmr-avantage ccmr-stagger" style={{ animationDelay: '0.24s' }}>
              <div className="ccmr-avantage-icon">
                <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20" fill="white">
            ...
            <div className="ccmr-avantage ccmr-stagger" style={{ animationDelay: '0.32s' }}>
              <div className="ccmr-avantage-icon">
                <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20" fill="white">
              ...
              <p>Pas de bail longue durée. Tu loues selon ton rythme, sans contrainte.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="ccmr-cta-section">
        <div className="ccmr-container">
          <div className="ccmr-cta ccmr-stagger">
            ...
            <div className="ccmr-cta-btns">
              <Link to="/inscription" className="ccmr-btn-primary">Créer mon compte</Link>
              <Link to="/connexion" className="ccmr-btn-secondary">Se connecter</Link>
            </div>
          </div>
        </div>
      </section>
