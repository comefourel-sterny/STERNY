...
export default function CommentCaMarchePage() {
  return (
    <section className="page-comment">
      <div className="comment-card">
        <div className="comment-header">
          <h1>Comment ça marche ?</h1>
          <p>Choisis ton profil pour en savoir plus</p>
        </div>

        <div className="profile-options">
          {/* Propriétaire */}
          <Link className="profile-card" to="/comment-ca-marche/proprietaire">
            ...
            <div className="card-content">
              ...
              <div className="card-description">J'ai un logement à louer à des alternants</div>
            </div>
          ...
          <Link className="profile-card" to="/comment-ca-marche/alterner">
            <div className="card-icon">
              <svg xmlns="http://www.w3.org/2000/svg" height="22px" viewBox="0 -960 960 960" width="22px" fill="#6B7280">
            ...
            <div className="card-content">
              <div className="card-title">J'ai un logement à partager</div>
              <div className="card-description">Je veux trouver un binôme pour diviser mon loyer</div>
            </div>
            <div className="card-arrow">
              <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20" fill="currentColor">
                <path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z" />
          ...
          <Link className="profile-card" to="/comment-ca-marche/recherche">
            <div className="card-icon">
              <svg xmlns="http://www.w3.org/2000/svg" height="22px" viewBox="0 -960 960 960" width="22px" fill="#6B7280">
            ...
            <div className="card-content">
              <div className="card-title">Je cherche un logement</div>
              <div className="card-description">Je veux trouver un logement adapté à mon alternance</div>
            </div>
            <div className="card-arrow">
              <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960" width="20" fill="currentColor">
                <path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z" />
